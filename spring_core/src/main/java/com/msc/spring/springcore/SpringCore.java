...
public class SpringCore {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        com.msc.spring.springcore.innerbean.Employee employee4 = (com.msc.spring.springcore.innerbean.Employee) innerBean.getBean("employee");
        System.out.println(employee4);

        com.msc.spring.springcore.innerbean.Employee employee2 = (com.msc.spring.springcore.innerbean.Employee) innerBean.getBean("employee");
        System.out.println(employee2.hashCode());

        com.msc.spring.springcore.innerbean.Employee employee3 = (com.msc.spring.springcore.innerbean.Employee) innerBean.getBean("employee");
